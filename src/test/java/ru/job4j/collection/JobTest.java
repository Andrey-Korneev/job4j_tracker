...
public class JobTest {
    ...
    @Test
    public void whenComparatorAscByNameAndPriorityOne() {
    ...
    @Test
    public void whenComparatorAscByNameAndPriorityTwo() {
        Comparator<Job> cmpNamePriority = new JobAscByName().thenComparing(new JobAscByPriority());
        int rsl = cmpNamePriority.compare(
                new Job("Impl task", 0),
                new Job("Impl task", 1)
    ...
    @Test
    public void whenComparatorDescByNameAndPriorityOne() {
    ...
    @Test
    public void whenComparatorDescByNameAndPriorityTwo() {
        Comparator<Job> cmpNamePriority = new JobDescByName().thenComparing(new JobDescByPriority());
        int rsl = cmpNamePriority.compare(
                new Job("Impl task", 0),
                new Job("Impl task", 1)
